import pygame
import game.world as wd
import game.point as pt

class Block:
    def __init__(self, xPos, yPos, halfDiagonal):
        self.points = [pt.Point(xPos, yPos - halfDiagonal),
                       pt.Point(xPos + halfDiagonal, yPos),
                       pt.Point(xPos, yPos + halfDiagonal),
                       pt.Point(xPos - halfDiagonal, yPos)]
    ...
    def paint(self,screen):
        ...
        pygame.draw.lines(screen,(21,71,52),True,coords)
